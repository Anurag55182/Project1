      ...
      <div className="pg6cards">
        <div className="pg6card1">
          <div className="pg6img">
            <img
              src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/Insurance.jpg"
              id="pg6img1"
              alt="jpeg"
            />
          </div>
        ...
        <div className="pg6card2">
          <div className="pg6img">
            <img
              src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/nespresso.jpg"
              id="pg6img2"
              alt=""
            />
          </div>
        ...
        <div className="pg6card3">
          <div className="pg6img">
            <img
              src="https://tecnologia.vamtam.com/wp-content/uploads/2023/03/undergroup.jpg"
              id="pg6img3"
              alt=""
            />
          </div>
